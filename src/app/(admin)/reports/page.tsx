...
export default async function ReportsPage({ searchParams }: ReportsPageProps) {
	...
	switch (activeTab) {
		...
		case "sales": {
			const { SalesHistoryTableWrapper, SalesSummaryWrapper } = await import(
				"./_components/tabs/sales"
			);
			tabContent = (
		...
		case "purchases": {
			const { PurchaseHistoryTableWrapper, PurchaseSummaryWrapper } =
				await import("./_components/tabs/purchases");
			tabContent = (
		...
		case "suppliers": {
			const { SupplierStatsWrapper, SupplierSummaryWrapper } = await import(
				"./_components/tabs/suppliers"
			);
			tabContent = (
		...
		case "customers": {
			const { CustomerStatsWrapper, CustomerSummaryWrapper } = await import(
				"./_components/tabs/customers"
			);
			tabContent = (
		...
		case "valuation": {
			const { ValuationSummaryWrapper, ValuationTableWrapper } = await import(
				"./_components/tabs/valuation"
			);
			tabContent = (
		...
		case "low-stock": {
			const { LowStockSummaryWrapper, LowStockTableWrapper } = await import(
				"./_components/tabs/low-stock"
			);
			tabContent = (
